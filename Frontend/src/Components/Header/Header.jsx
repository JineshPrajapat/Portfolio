    ...
    return (
        <div>
            <header className=' w-full bg-white border-b-2 fixed top-0 left-0 z-50 font-mono'>
                <div className='p-4 md:py-2 flex flex-row items-center justify-between'>
                    <div className=''>
                    ...
                    {isMobile ? (
                        ...
                        <div className='right-side flex flex-row justify-evenly gap-5 '>
                            <ul className='flex gap-8'>
                                {Menus?.map((menu, i) => (
                                    <li className={`links`} key={i}>
                                        <NavLink
                                            className={`flex gap-3 py-2 px-2 duration-300 transition-all hover:bg-gray-200 ${path === menu.path ? "underline" : ""}`}
                                            to={menu.path}
                                            activeClassName="text-blue"
                                            onClick={() => handleClick(i)}
                                        >
